...
const FloatingWA = ({ whatsappNumbers, message, features }: FloatingWAProps) => {
    ...
    return (
        <a
            ...
            className="fixed bottom-8 right-8 z-50 bg-brand-green text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 group"
        ...
        >
            ...
            <span className="absolute inset-0 rounded-full brand-green animate-ping opacity-20" />
        </a>
    );
};
